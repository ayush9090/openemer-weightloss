    ...
    public function checkInventory(&$prod)
    {
        ...
        if (is_array($prod)) {
            foreach ($prod as $iter) {
                ...
                if ($sale_id) {
                    $query = "SELECT ds.quantity, ds.inventory_id, di.warehouse_id, lo.option_value as facility_id " .
                    ...
                    // Check if warehouse belongs to current facility
                    if ($warehouse_id) {
                        $wrow = sqlQuery(
                            "SELECT option_value as facility_id FROM list_options " .
                            "WHERE list_id = 'warehouse' AND option_id = ?",
                            array($warehouse_id)
                        );
                        if ($wrow && $wrow['facility_id'] != $facility_id) {
